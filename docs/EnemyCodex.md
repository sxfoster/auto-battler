...
|-----------|------|--------|--------|----------|-------|
| Blood Boil | 1 | 2 dark damage; heal if cursed | Enemy | Instant | |
| Hex of Weakness | 1 | -2 ATK/DEF | Enemy | 2 turns | |
| Blood Pact | 1 | Heal ally 4, lose 2 HP | Ally | Instant | |
| Vile Mending | 1 | Cleanse curses, heal 4 | Self | Instant | |
| Dark Benediction | 2 | Allies +1 dmg, take +1 dmg | All Allies | 2 turns | |
...
| War Shout | 1 | Taunt all enemies, +2 DEF | Self | 1 turn | |
| Juggernaut Rush | 2 | 2 AoE damage, gain 5 Shield | All Enemies/Self | Instant | |
...
| Glacial Chains | 1 | Root target | Enemy | 1 turn | |
| Blizzard | 2 | 1 AoE cold damage, Slow | All Enemies | 1 turn | |
| Ice Shield | 1 | 5 Shield, immune to Slow | Self | 2 turns | |
| Shatter | 1 | 4 damage to slowed target | Enemy | Instant | |
...
| Card Name | Cost | Effect | Target | Duration | Notes |
|-----------|------|--------|--------|----------|-------|
| Titanic Slam | 2 | 3 damage, knockback | Enemy | 1 turn | |
| Bone Plating | 1 | 8 Shield | Self | 2 turns | |
| Earthquake | 2 | 2 AoE damage, -1 initiative | All Enemies | 1 turn | |
| Siege Step | 1 | Taunt, next attack +2 dmg | Self | 1 turn | |
...
| Card Name | Cost | Effect | Target | Duration | Notes |
|-----------|------|--------|--------|----------|-------|
| Inferno Breath | 2 | 2 AoE fire damage, Burn | All Enemies | 2 turns | |
...
| Sear Flesh | 1 | 2 fire damage, cannot heal | Enemy | 2 turns | |
...
| Card Name | Cost | Effect | Target | Duration | Notes |
|-----------|------|--------|--------|----------|-------|
| Summon Skeleton | 2 | Add Skeleton Minion | Field | Until KO'd | |
| Fear | 2 | Target skips next turn | Enemy | 1 turn | |
| Grave Touch | 1 | 2 damage, heal 2 if KO | Enemy | Instant | |
| Bone Armor | 1 | 5 Shield | Self | 2 turns | |
...
| Infection | 1 | 2 poison damage, cannot heal | Enemy | 2 turns | |
| Virulent Burst | 1 | Spread all debuffs to all enemies | Enemy | Instant | |
| Rotting Touch | 1 | 1 damage, Weak (-2 ATK) | Enemy | 2 turns | |
...
| Cloak of Dusk | 1 | 5 Shield, +30% dodge | Self | 2 turns | |
| Mark for Death | 1 | Next attack deals double damage | Enemy | 1 turn | |
...
| Card Name | Cost | Effect | Target | Duration | Notes |
|-----------|------|--------|--------|----------|-------|
| Chain Lightning | 2 | 2 AoE lightning damage, Shock | All Enemies | 1 turn | |
| Static Field | 1 | 1 damage on enemy turns | All Enemies | 2 turns | |
| Flash Strike | 1 | 3 damage, +1 initiative | Enemy | 1 turn | |
...
| Card Name | Cost | Effect | Target | Duration | Notes |
|-----------|------|--------|--------|----------|-------|
| Reality Tear | 1 | 3 arcane damage, shuffle deck | Enemy | Instant | |
| Null Pulse | 2 | All enemies lose 2 energy | All Enemies | Instant | |
| Warp Echo | 1 | Copy last ability used | Enemy | Instant | |
| Paranoia | 1 | Enemy attacks ally instead | Enemy | 1 turn | |
| Entropic Field | 2 | Remove all buffs from enemies | All Enemies | Instant | |
