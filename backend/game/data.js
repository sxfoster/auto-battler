...
const allPossibleAbilities = [
    ...
    { id: 4002, type: 'ability', name: 'Mirror Image', class: 'Mystic Deceiver', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Mirror%20Image', effect: 'Gain +1 Evasion for 2 turns.', energyCost: 1, category: 'Defense' },
    { id: 4003, type: 'ability', name: 'Mind Fog', class: 'Mystic Deceiver', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Mind%20Fog', effect: 'Apply Confuse to one enemy for 1 turn.', energyCost: 1, category: 'Support' },
    // Uncommon
    { id: 4004, type: 'ability', name: 'Illusionary Strike', class: 'Mystic Deceiver', rarity: 'Uncommon', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Illusionary%20Strike', effect: 'Deal 3 damage. If the target is Confused, they are also Stunned.', energyCost: 2, category: 'Offense' },
    ...
    { id: 4006, type: 'ability', name: 'Charm', class: 'Mystic Deceiver', rarity: 'Uncommon', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Charm', effect: 'An enemy attacks one of its own allies on its next turn.', energyCost: 2, category: 'Support' },
    // Rare
    ...
    { id: 4103, type: 'ability', name: 'Poisoned Shiv', class: 'Shadow Striker', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Poisoned%20Shiv', effect: 'Deal 1 damage and apply Poison (1 damage per turn for 2 turns).', energyCost: 1, category: 'Support' },
    // Uncommon
    { id: 4104, type: 'ability', name: 'Backstab', class: 'Shadow Striker', rarity: 'Uncommon', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Backstab', effect: 'Deal 4 damage. If the target has a debuff, this attack cannot be blocked.', energyCost: 2, category: 'Offense' },
    { id: 4105, type: 'ability', name: 'Smoke Bomb', class: 'Shadow Striker', rarity: 'Uncommon', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Smoke%20Bomb', effect: 'All allies gain +1 Evasion for 1 turn.', energyCost: 2, category: 'Defense', target: 'ALLIES' },
    ...
    { id: 4203, type: 'ability', name: 'Ice Lance', class: 'Arcane Savant', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Ice%20Lance', effect: 'Deal 1 damage and apply Slow for 2 turns.', energyCost: 1, category: 'Support' },
    // Uncommon
    ...
    { id: 4206, type: 'ability', name: 'Arcane Focus', class: 'Arcane Savant', rarity: 'Uncommon', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Arcane%20Focus', effect: 'Your next ability costs 1 less Energy and deals +1 damage.', energyCost: 2, category: 'Support' },
    // Rare
