...
const allPossibleAbilities = [
    ...
    // Common
    { id: 4001, type: 'ability', name: 'Mind Twist', class: 'Mystic Deceiver', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Mind%20Twist', effect: 'Deal 2 psychic damage.', energyCost: 1, category: 'Offense' },
    ...
    { id: 4003, type: 'ability', name: 'Mind Fog', class: 'Mystic Deceiver', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Mind%20Fog', effect: "Reduce an enemy's accuracy by 50% for 2 turns.", energyCost: 1, category: 'Support' },
    // Uncommon
    { id: 4004, type: 'ability', name: 'Illusionary Strike', class: 'Mystic Deceiver', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Illusionary%20Strike', effect: 'Deal 2 damage and confuse the target (50% chance they miss their next action).', energyCost: 1, category: 'Offense' },
    ...
    { id: 4006, type: 'ability', name: 'Charm', class: 'Mystic Deceiver', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Charm', effect: 'Temporarily turn an enemy into an ally for 1 turn.', energyCost: 1, category: 'Support' },
    // Rare
    ...
    // Common
    { id: 4101, type: 'ability', name: 'Quick Stab', class: 'Shadow Striker', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Quick%20Stab', effect: 'Deal 3 piercing damage.', energyCost: 1, category: 'Offense' },
    { id: 4102, type: 'ability', name: 'Fade', class: 'Shadow Striker', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Fade', effect: 'Gain +1 Evasion for 2 turns.', energyCost: 1, category: 'Defense' },
    { id: 4103, type: 'ability', name: 'Poison Blade', class: 'Shadow Striker', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Poison%20Blade', effect: 'Deal 1 damage and apply Poison (1 damage per turn for 3 turns).', energyCost: 1, category: 'Support' },
    // Uncommon
    { id: 4104, type: 'ability', name: 'Backstab', class: 'Shadow Striker', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Backstab', effect: 'Deal 2 damage, or 4 damage if the enemy is stunned or distracted.', energyCost: 1, category: 'Offense' },
    { id: 4105, type: 'ability', name: 'Smoke Bomb', class: 'Shadow Striker', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Smoke%20Bomb', effect: 'Gain +2 evasion for 2 turns.', energyCost: 1, category: 'Defense' },
    ...
    // Common
    { id: 4201, type: 'ability', name: 'Fireball', class: 'Arcane Savant', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Fireball', effect: 'Deal 3 fire damage to a single target.', energyCost: 1, category: 'Offense' },
    { id: 4202, type: 'ability', name: 'Arcane Shield', class: 'Arcane Savant', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Arcane%20Shield', effect: 'Gain 4 temporary HP that lasts for 2 turns.', energyCost: 1, category: 'Defense' },
    { id: 4203, type: 'ability', name: 'Ice Lance', class: 'Arcane Savant', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Ice%20Lance', effect: 'Deal 2 ice damage and slow the enemy (reduce speed by 1 for 2 turns).', energyCost: 1, category: 'Offense' },
    // Uncommon
    ...
    { id: 4206, type: 'ability', name: 'Arcane Focus', class: 'Arcane Savant', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Arcane%20Focus', effect: 'Gain +1 attack and +1 crit chance for your next spell.', energyCost: 1, category: 'Support' },
    // Rare
    ...
    { id: 5001, type: 'ability', name: 'Crushing Blow', class: 'Grave Titan', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Crushing%20Blow', effect: 'Deal 4 damage to a single target.', energyCost: 1, category: 'Offense' },
    { id: 5002, type: 'ability', name: 'Stonehide', class: 'Grave Titan', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Stonehide', effect: 'Reduce all incoming damage by 2 this turn.', energyCost: 1, category: 'Defense' },
