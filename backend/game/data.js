...
const allPossibleAbilities = [
    ...
    // Common
    { id: 3511, type: 'ability', name: 'Divine Light', class: 'Divine Healer', rarity: 'Common', art: 'https://placehold.co/150x126/ef4444/FFFFFF?text=Ability', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Divine%20Light', effect: 'Heal an ally for 4 HP.', energyCost: 2, category: 'Support' },
    ...
    { id: 3612, type: 'ability', name: 'Regrowth', class: 'Nature Shaper', rarity: 'Common', art: 'https://placehold.co/150x126/ef4444/FFFFFF?text=Ability', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Regrowth', effect: 'Heal an ally for 2 HP per turn over 3 turns.', energyCost: 2, category: 'Support' },
    ...
    // Common
    { id: 4001, type: 'ability', name: 'Mind Twist', class: 'Mystic Deceiver', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Mind%20Twist', effect: 'Deal 2 psychic damage.', energyCost: 2, category: 'Offense' },
    { id: 4002, type: 'ability', name: 'Mirror Image', class: 'Mystic Deceiver', rarity: 'Uncommon', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Mirror%20Image', effect: 'Create an illusion, giving you +2 evasion for 2 turns.', energyCost: 2, category: 'Defense' },
    { id: 4003, type: 'ability', name: 'Mind Fog', class: 'Mystic Deceiver', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Mind%20Fog', effect: "Reduce an enemy's accuracy by 50% for 2 turns.", energyCost: 2, category: 'Support' },
    // Uncommon
    ...
    { id: 4005, type: 'ability', name: 'Arcane Ward', class: 'Mystic Deceiver', rarity: 'Uncommon', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Arcane%20Ward', effect: 'Block the next incoming magical ability.', energyCost: 2, category: 'Defense' },
    { id: 4006, type: 'ability', name: 'Charm', class: 'Mystic Deceiver', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Charm', effect: 'Temporarily turn an enemy into an ally for 1 turn.', energyCost: 2, category: 'Support' },
    // Rare
    { id: 4007, type: 'ability', name: 'Phantasmal Blades', class: 'Mystic Deceiver', rarity: 'Rare', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Phantasmal%20Blades', effect: 'Deal 2 damage to all enemies and apply Confuse for 1 turn.', energyCost: 3, category: 'Offense', target: 'ENEMIES' },
    { id: 4008, type: 'ability', name: 'Warding Sigil', class: 'Mystic Deceiver', rarity: 'Rare', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Warding%20Sigil', effect: 'All allies gain immunity to debuffs for 2 turns.', energyCost: 3, category: 'Defense', target: 'ALLIES' },
    { id: 4009, type: 'ability', name: 'Dominate Mind', class: 'Mystic Deceiver', rarity: 'Rare', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Dominate%20Mind', effect: 'Force an enemy to perform a basic attack against itself.', energyCost: 3, category: 'Support' },
    // Epic
    { id: 4010, type: 'ability', name: 'Mind Shatter', class: 'Mystic Deceiver', rarity: 'Epic', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Mind%20Shatter', effect: 'Deal 5 psychic damage. If the target has a debuff, this damage cannot be blocked.', energyCost: 4, category: 'Offense' },
    { id: 4011, type: 'ability', name: 'Cloak of Invisibility', class: 'Mystic Deceiver', rarity: 'Epic', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Cloak%20of%20Invisibility', effect: 'This hero becomes untargetable for 2 turns.', energyCost: 4, category: 'Defense' },
    { id: 4012, type: 'ability', name: 'Mass Domination', class: 'Mystic Deceiver', rarity: 'Epic', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Mass%20Domination', effect: 'All enemies have a 50% chance to attack their own allies on their next turn.', energyCost: 4, category: 'Support', target: 'ENEMIES' },

    // === Shadow Striker (Rogue) ===
    // Common
    { id: 4101, type: 'ability', name: 'Quick Stab', class: 'Shadow Striker', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Quick%20Stab', effect: 'Deal 3 piercing damage.', energyCost: 2, category: 'Offense' },
    { id: 4102, type: 'ability', name: 'Fade', class: 'Shadow Striker', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Fade', effect: 'Gain +1 Evasion for 2 turns.', energyCost: 2, category: 'Defense' },
    { id: 4103, type: 'ability', name: 'Poison Blade', class: 'Shadow Striker', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Poison%20Blade', effect: 'Deal 1 damage and apply Poison (1 damage per turn for 3 turns).', energyCost: 2, category: 'Support' },
    // Uncommon
    ...
    { id: 4105, type: 'ability', name: 'Smoke Bomb', class: 'Shadow Striker', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Smoke%20Bomb', effect: 'Gain +2 evasion for 2 turns.', energyCost: 2, category: 'Defense' },
    { id: 4106, type: 'ability', name: 'Bleeding Strike', class: 'Shadow Striker', rarity: 'Uncommon', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Bleeding%20Strike', effect: 'Deal 2 damage and apply Bleed for 2 turns.', energyCost: 2, category: 'Support' },
    // Rare
    { id: 4107, type: 'ability', name: 'Flurry of Blades', class: 'Shadow Striker', rarity: 'Rare', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Flurry%20of%20Blades', effect: 'Deal 2 damage to three random enemies.', energyCost: 3, category: 'Offense' },
    { id: 4108, type: 'ability', name: 'Shadow Step', class: 'Shadow Striker', rarity: 'Rare', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Shadow%20Step', effect: 'Avoid the next incoming attack completely.', energyCost: 3, category: 'Defense' },
    { id: 4109, type: 'ability', name: 'Deadly Poison', class: 'Shadow Striker', rarity: 'Rare', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Deadly%20Poison', effect: 'Apply Poison (2 damage per turn for 3 turns) to all enemies.', energyCost: 3, category: 'Support', target: 'ENEMIES' },
    // Epic
    { id: 4110, type: 'ability', name: 'Assassinate', class: 'Shadow Striker', rarity: 'Epic', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Assassinate', effect: 'Deal 7 damage to a single target. If this defeats the target, gain 2 Energy.', energyCost: 4, category: 'Offense' },
    { id: 4111, type: 'ability', name: 'Cloak of Shadows', class: 'Shadow Striker', rarity: 'Epic', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Cloak%20of%20Shadows', effect: 'Become untargetable for 1 turn and gain +2 Attack on your next turn.', energyCost: 4, category: 'Defense' },
    { id: 4112, type: 'ability', name: 'Shadow Mastery', class: 'Shadow Striker', rarity: 'Epic', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Shadow%20Mastery', effect: 'For 2 turns, all of your attacks are guaranteed critical hits.', energyCost: 4, category: 'Support' },
    ...
    { id: 4202, type: 'ability', name: 'Arcane Shield', class: 'Arcane Savant', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Arcane%20Shield', effect: 'Gain 4 temporary HP that lasts for 2 turns.', energyCost: 2, category: 'Defense' },
    { id: 4203, type: 'ability', name: 'Ice Lance', class: 'Arcane Savant', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Ice%20Lance', effect: 'Deal 2 ice damage and slow the enemy (reduce speed by 1 for 2 turns).', energyCost: 2, category: 'Offense' },
    // Uncommon
    { id: 4204, type: 'ability', name: 'Lightning Bolt', class: 'Arcane Savant', rarity: 'Uncommon', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Lightning%20Bolt', effect: 'Deal 4 lightning damage. Has a 25% chance to Stun.', energyCost: 2, category: 'Offense' },
    { id: 4205, type: 'ability', name: 'Counterspell', class: 'Arcane Savant', rarity: 'Uncommon', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Counterspell', effect: 'If an enemy casts an ability next, interrupt it and deal 2 damage to them.', energyCost: 2, category: 'Defense' },
    { id: 4206, type: 'ability', name: 'Arcane Focus', class: 'Arcane Savant', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Arcane%20Focus', effect: 'Gain +1 attack and +1 crit chance for your next spell.', energyCost: 2, category: 'Support' },
    // Rare
    { id: 4207, type: 'ability', name: 'Ice Storm', class: 'Arcane Savant', rarity: 'Rare', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Ice%20Storm', effect: 'Deal 2 ice damage to all enemies and apply Slow for 2 turns.', energyCost: 3, category: 'Offense', target: 'ENEMIES' },
    { id: 4208, type: 'ability', name: 'Time Warp', class: 'Arcane Savant', rarity: 'Rare', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Time%20Warp', effect: 'This hero takes their next turn immediately after this one.', energyCost: 3, category: 'Defense' },
    { id: 4209, type: 'ability', name: 'Mana Drain', class: 'Arcane Savant', rarity: 'Rare', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Mana%20Drain', effect: 'Steal 2 Energy from an enemy.', energyCost: 3, category: 'Support' },
    // Epic
    { id: 4210, type: 'ability', name: 'Meteor Shower', class: 'Arcane Savant', rarity: 'Epic', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Meteor%20Shower', effect: 'Deal 6 fire damage to all enemies.', energyCost: 4, category: 'Offense', target: 'ENEMIES' },
    { id: 4211, type: 'ability', name: 'Prismatic Wall', class: 'Arcane Savant', rarity: 'Epic', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Prismatic%20Wall', effect: 'All allies take 50% less damage from all sources for 1 turn.', energyCost: 4, category: 'Defense', target: 'ALLIES' },
    { id: 4212, type: 'ability', name: 'Temporal Mastery', class: 'Arcane Savant', rarity: 'Epic', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Temporal%20Mastery', effect: 'For 2 turns, this hero gets an extra action on each of their turns.', energyCost: 4, category: 'Support' },

    // === MONSTER ABILITIES ===
    // Grave Titan Abilities (sample)
    { id: 5001, type: 'ability', name: 'Crushing Blow', class: 'Grave Titan', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Crushing%20Blow', effect: 'Deal 4 damage to a single target.', energyCost: 2, category: 'Offense' },
    { id: 5002, type: 'ability', name: 'Stonehide', class: 'Grave Titan', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Stonehide', effect: 'Reduce all incoming damage by 2 this turn.', energyCost: 2, category: 'Defense' },

    // Brute Abilities (sample)
    { id: 5101, type: 'ability', name: 'Savage Swipe', class: 'Brute', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Savage%20Swipe', effect: 'Deal 3 damage to two enemies.', energyCost: 2, category: 'Offense' },

    // Grave Titan additional abilities
    { id: 5003, type: 'ability', name: 'Titanic Slam', class: 'Grave Titan', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Titanic%20Slam', effect: 'Deal 2 damage and Stun the target if they acted this turn.', energyCost: 2, category: 'Offense' },

    // Brute abilities
    { id: 5102, type: 'ability', name: 'Thick Hide', class: 'Brute', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Thick%20Hide', effect: 'Gain +2 Defense this turn.', energyCost: 2, category: 'Defense' },
    { id: 5103, type: 'ability', name: 'Bonecrusher Slam', class: 'Brute', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Bonecrusher%20Slam', effect: 'Deal 3 damage and Stun for 1 turn.', energyCost: 2, category: 'Offense' },

    // Frost Revenant abilities
    { id: 5201, type: 'ability', name: 'Icy Touch', class: 'Frost Revenant', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Icy%20Touch', effect: 'Deal 2 damage and apply Slow for 1 turn.', energyCost: 2, category: 'Offense' },
    { id: 5202, type: 'ability', name: 'Ice Barrier', class: 'Frost Revenant', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Ice%20Barrier', effect: 'Reduce incoming damage by 2 this turn.', energyCost: 2, category: 'Defense' },
    { id: 5203, type: 'ability', name: 'Hail Shard', class: 'Frost Revenant', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Hail%20Shard', effect: 'Deal 1 damage to all enemies and Slow them for 1 turn.', energyCost: 2, category: 'Support', target: 'ENEMIES' },

    // Blood Witch abilities
    { id: 5301, type: 'ability', name: 'Blood Leech', class: 'Blood Witch', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Blood%20Leech', effect: 'Deal 2 damage and heal 2 HP.', energyCost: 2, category: 'Offense' },
    { id: 5302, type: 'ability', name: 'Blood Mist', class: 'Blood Witch', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Blood%20Mist', effect: 'Fear an enemy and gain +1 Evasion this turn.', energyCost: 2, category: 'Defense' },
    { id: 5303, type: 'ability', name: 'Hex', class: 'Blood Witch', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Hex', effect: 'Apply -1 Attack to an enemy for 2 turns.', energyCost: 2, category: 'Support' },

    // Infernal Beast abilities
    { id: 5401, type: 'ability', name: 'Fiery Bite', class: 'Infernal Beast', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Fiery%20Bite', effect: 'Deal 3 damage. If the target is Burning, deal +1 damage.', energyCost: 2, category: 'Offense' },
    { id: 5402, type: 'ability', name: 'Molten Scales', class: 'Infernal Beast', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Molten%20Scales', effect: 'Reflect 1 damage to attackers this turn.', energyCost: 2, category: 'Defense' },
    { id: 5403, type: 'ability', name: 'Lava Breath', class: 'Infernal Beast', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Lava%20Breath', effect: 'Deal 1 fire damage to all enemies and apply Burn for 1 turn.', energyCost: 2, category: 'Support', target: 'ENEMIES' },

    // Necromancer abilities
    { id: 5501, type: 'ability', name: 'Bone Spear', class: 'Necromancer', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Bone%20Spear', effect: 'Deal 3 damage to a single enemy.', energyCost: 2, category: 'Offense' },
    { id: 5502, type: 'ability', name: "Lich's Shield", class: 'Necromancer', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Lich%27s%20Shield', effect: 'Block the next attack against you or an ally.', energyCost: 2, category: 'Defense' },
    { id: 5503, type: 'ability', name: 'Raise Skeleton', class: 'Necromancer', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Raise%20Skeleton', effect: 'Summon a Skeleton minion.', energyCost: 2, category: 'Support' },

    // Shadowfiend abilities
    { id: 5601, type: 'ability', name: 'Shadow Slash', class: 'Shadowfiend', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Shadow%20Slash', effect: 'Deal 3 damage. If you have Evasion, deal +1 damage.', energyCost: 2, category: 'Offense' },
    { id: 5602, type: 'ability', name: 'Fade Into Shadows', class: 'Shadowfiend', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Fade%20Into%20Shadows', effect: 'Gain +2 Evasion for 1 turn.', energyCost: 2, category: 'Defense' },
    { id: 5603, type: 'ability', name: 'Venom Shank', class: 'Shadowfiend', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Venom%20Shank', effect: 'Deal 1 damage and apply Poison for 2 turns.', energyCost: 2, category: 'Support' },

    // Storm Serpent abilities
    { id: 5701, type: 'ability', name: 'Lightning Bite', class: 'Storm Serpent', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Lightning%20Bite', effect: 'Deal 3 lightning damage and apply Shock.', energyCost: 2, category: 'Offense' },
    { id: 5702, type: 'ability', name: 'Electric Veil', class: 'Storm Serpent', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Electric%20Veil', effect: 'Reduce damage by 1 this turn and Shock attackers.', energyCost: 2, category: 'Defense' },
    { id: 5703, type: 'ability', name: 'Storm Surge', class: 'Storm Serpent', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Storm%20Surge', effect: 'Gain +1 Speed and +1 Attack for 1 turn.', energyCost: 2, category: 'Support' },

    // Venomspawn abilities
    { id: 5801, type: 'ability', name: 'Venomous Strike', class: 'Venomspawn', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Venomous%20Strike', effect: 'Deal 1 damage and apply Poison for 2 turns.', energyCost: 2, category: 'Offense' },
    { id: 5802, type: 'ability', name: 'Acid Spit', class: 'Venomspawn', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Acid%20Spit', effect: 'Deal 1 damage and reduce target\u2019s Defense by 1 for 2 turns.', energyCost: 2, category: 'Defense' },
    { id: 5803, type: 'ability', name: 'Lurking Poison', class: 'Venomspawn', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Lurking%20Poison', effect: 'Apply Poison (1 damage per turn for 3 turns).', energyCost: 2, category: 'Support' },

    // Void Horror abilities
    { id: 5901, type: 'ability', name: 'Warping Claws', class: 'Void Horror', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Warping%20Claws', effect: 'Deal 2 damage and the target discards 1 card at random.', energyCost: 2, category: 'Offense' },
    { id: 5902, type: 'ability', name: 'Reality Tear', class: 'Void Horror', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Reality%20Tear', effect: 'Deal 3 damage and apply Fear for 1 turn.', energyCost: 2, category: 'Defense' },
    { id: 5903, type: 'ability', name: 'Void Pulse', class: 'Void Horror', rarity: 'Common', art: '...', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Void%20Pulse', effect: 'Steal 1 Energy from an enemy.', energyCost: 2, category: 'Support' },
];
