...
const allPossibleAbilities = [
    ...
    { id: 3312, type: 'ability', name: 'Raging Strike', class: 'Raging Fighter', rarity: 'Common', art: 'https://placehold.co/150x126/ef4444/FFFFFF?text=Ability', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Raging%20Strike', effect: 'Deal 3 damage and apply Armor Break for 1 turn (target takes +1 damage), but reduce your defense by 1 until next turn.', energyCost: 2, category: 'Defense' },
