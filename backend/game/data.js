...
const allPossibleWeapons = [
    ...
    { id: 1102, type: 'weapon', name: 'Iron Sword', rarity: 'Uncommon', art: '../img/weapons/iron_sword_card.png', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Iron%20Sword', statBonuses: { ATK: 5 }, procs: [{ trigger: 'on_attack', effect: 'cleave', value: 1, target: 'adjacent_enemies' }] },
    { id: 1103, type: 'weapon', name: 'Steel Longsword', rarity: 'Rare', art: '../img/weapons/steel_longsword_card.png', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Steel%20Longsword', statBonuses: { ATK: 7, HP: 3 }, procs: [{ trigger: 'on_attack', effect: 'cleave', value: 2, target: 'adjacent_enemies' }] },
    { id: 1104, type: 'weapon', name: 'Dragonfang Blade', rarity: 'Epic', art: '../img/weapons/dragonfang_blade_card.png', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Dragonfang%20Blade', statBonuses: { ATK: 10, SPD: 5 }, procs: [{ trigger: 'on_kill', effect: 'extra_attack' }] },
    ...
    { id: 1202, type: 'weapon', name: 'Battle Axe', rarity: 'Uncommon', art: '../img/weapons/battle_axe_card.png', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Battle%20Axe', statBonuses: { ATK: 7, SPD: -2 }, procs: [{ trigger: 'on_attack', effect: 'ignore_block', value: 1 }] },
    { id: 1203, type: 'weapon', name: 'Great Axe', rarity: 'Rare', art: '../img/weapons/great_axe_card.png', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Great%20Axe', statBonuses: { ATK: 10, SPD: -3 }, procs: [{ trigger: 'on_attack', effect: 'bonus_damage', value: 2, condition: { target_hp_below: 0.5 } }] },
    { id: 1204, type: 'weapon', name: 'Stormreaver', rarity: 'Epic', art: '../img/weapons/stormreaver_card.png', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Stormreaver', statBonuses: { ATK: 15, SPD: -4 }, procs: [{ trigger: 'on_attack', effect: 'double_damage', condition: { first_attack: true } }, { trigger: 'on_attack', effect: 'recoil_damage', value: 5, condition: { first_attack: true } }] },
    ...
    { id: 1302, type: 'weapon', name: 'Bandit Dirk', rarity: 'Uncommon', art: '../img/weapons/bandit_dirk_card.png', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Bandit%20Dirk', statBonuses: { ATK: 2, SPD: 4 }, procs: [{ trigger: 'on_hit', effect: 'apply_status', status: 'Poison', duration: 2, chance: 0.25 }] },
    { id: 1303, type: 'weapon', name: "Assassin's Stiletto", rarity: 'Rare', art: '../img/weapons/assassins_stiletto_card.png', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Improved%20Poison%20Tip', statBonuses: { ATK: 4, SPD: 6 }, procs: [{ trigger: 'on_hit', effect: 'apply_status', status: 'Poison', duration: 2, chance: 0.5, value: 2 }] },
    { id: 1304, type: 'weapon', name: 'Venombite Fang', rarity: 'Epic', art: '../img/weapons/venombite_fang_card.png', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Venombite%20Fang', statBonuses: { ATK: 6, SPD: 8 }, procs: [{ trigger: 'on_attack', effect: 'bonus_damage', value: 3, condition: { target_has_status: ['Poison', 'Bleed'] } }] },
    ...
    { id: 1402, type: 'weapon', name: 'Iron Morningstar', rarity: 'Uncommon', art: '../img/weapons/iron_morningstar_card.png', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Iron%20Morningstar', statBonuses: { ATK: 4, HP: 3 }, procs: [{ trigger: 'on_hit', effect: 'apply_status', status: 'Slow', duration: 1, chance: 0.2 }] },
    { id: 1403, type: 'weapon', name: 'Sunforge Maul', rarity: 'Rare', art: '../img/weapons/sunforge_maul_card.png', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Sunforge%20Maul', statBonuses: { ATK: 6, HP: 5 }, procs: [{ trigger: 'on_hit', effect: 'modify_stat', stat: 'defense', value: -1, permanent: true }] },
    { id: 1404, type: 'weapon', name: 'Relic of Judgement', rarity: 'Epic', art: '../img/weapons/relic_of_judgement_card.png', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Relic%20of%20Judgement', statBonuses: { ATK: 9, HP: 7 }, procs: [{ trigger: 'on_hit', effect: 'apply_status', status: 'Stun', duration: 1, chance: 0.5, condition: { first_attack: true } }] },
    ...
    { id: 1502, type: 'weapon', name: "Soldier's Pike", rarity: 'Uncommon', art: '../img/weapons/soldiers_pike_card.png', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Disrupting%20Thrust', statBonuses: { ATK: 4, SPD: 2 }, procs: [{ trigger: 'on_hit', effect: 'apply_status', status: 'Slow', duration: 1 }] },
    { id: 1503, type: 'weapon', name: 'Celestial Glaive', rarity: 'Rare', art: '../img/weapons/celestial_glaive_card.png', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Celestial%20Glaive', statBonuses: { ATK: 6, SPD: 3 }, procs: [{ trigger: 'on_attack', effect: 'bonus_damage', value: 3, condition: { attacker_is_faster: true, first_attack: true } }] },
    { id: 1504, type: 'weapon', name: 'Wyrmspire Lance', rarity: 'Epic', art: '../img/weapons/wyrmspire_lance_card.png', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Wyrmspire%20Lance', statBonuses: { ATK: 8, SPD: 4 }, procs: [{ trigger: 'on_attacked', effect: 'apply_status_to_attacker', status: 'Stun', duration: 1, condition: { first_hit_taken: true } }] },
    ...
    { id: 1603, type: 'weapon', name: 'Elven Warbow', rarity: 'Rare', art: '../img/weapons/elven_warbow_card.png', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Elven%20Warbow', statBonuses: { ATK: 7, SPD: 3 }, procs: [{ trigger: 'on_hit', effect: 'apply_status', status: 'Attack Down', value: 2, duration: 1, condition: { target_is_last_in_row: true } }] },
    { id: 1604, type: 'weapon', name: 'Heartwood Stormbow', rarity: 'Epic', art: '../img/weapons/heartwood_stormbow_card.png', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Heartwood%20Stormbow', statBonuses: { ATK: 10, SPD: 5 }, procs: [{ trigger: 'on_attack', effect: 'cannot_be_evaded' }] },
    ...
    { id: 1702, type: 'weapon', name: 'Apprentice Rod', rarity: 'Uncommon', art: '../img/weapons/apprentice_rod_card.png', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Apprentice%20Rod', statBonuses: { HP: 5, SPD: 3 }, procs: [{ trigger: 'on_ability_used', effect: 'heal_self', value: 2 }] },
    { id: 1703, type: 'weapon', name: "Sagewood Staff", rarity: 'Rare', art: '../img/weapons/sagewood_staff_card.png', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Spell%20Power', statBonuses: { HP: 8, SPD: 4 }, procs: [{ trigger: 'on_ability_used', effect: 'boost_ability_damage', value: 2 }] },
    { id: 1704, type: 'weapon', name: 'Archmage Catalyst', rarity: 'Epic', art: '../img/weapons/archmage_catalyst_card.png', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Archmage%20Catalyst', statBonuses: { HP: 12, SPD: 5 }, procs: [{ trigger: 'on_combat_start', effect: 'gain_energy', value: 1 }] },
    ...
    { id: 1802, type: 'weapon', name: 'Iron Kite Shield', rarity: 'Uncommon', art: '../img/weapons/iron_kite_shield_card.png', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Iron%20Kite%20Shield', statBonuses: { HP: 8 }, procs: [{ trigger: 'on_combat_start', effect: 'modify_stat', stat: 'defense', value: 1 }] },
    { id: 1803, type: 'weapon', name: 'Lionheart Wall', rarity: 'Rare', art: '../img/weapons/lionheart_wall_card.png', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Lionheart%20Wall', statBonuses: { HP: 12 }, procs: [{ trigger: 'on_combat_start', effect: 'modify_stat', stat: 'defense', value: 2 }] },
    { id: 1804, type: 'weapon', name: 'Aegis of the Ages', rarity: 'Epic', art: '../img/weapons/aegis_of_the_ages_card.png', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Aegis%20of%20the%20Ages', statBonuses: { HP: 15 }, procs: [{ trigger: 'on_hit', effect: 'apply_buff_to_ally', stat: 'defense', value: 1, target: 'adjacent_ally' }] }
];
...
const allPossibleArmors = [
    ...
    { id: 2104, type: 'armor', name: 'Phantom Cloak', rarity: 'Epic', armorType: 'Light', art: '../img/armor/phantom_cloak_card.png', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Phantom%20Cloak', statBonuses: { DEFENSE: 2, SPD: 2 }, procs: [{ trigger: 'on_attacked', effect: 'ignore_damage', once_per_combat: true }] },
    ...
    { id: 2203, type: 'armor', name: 'Vanguard Mail', rarity: 'Rare', armorType: 'Medium', art: '../img/armor/vanguard_mail_card.png', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Vanguard%20Mail', statBonuses: { DEFENSE: 3 }, procs: [{ trigger: 'on_hit', effect: 'reflect_damage', value: 1, condition: { is_melee: true } }] },
    { id: 2204, type: 'armor', name: 'Captain’s Bulwark', rarity: 'Epic', armorType: 'Medium', art: '../img/armor/captains_bulwark_card.png', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Captain%E2%80%99s%20Bulwark', statBonuses: { DEFENSE: 4 }, procs: [{ trigger: 'on_combat_start', effect: 'aura_buff_allies', stat: 'defense', value: 1, target: 'adjacent_allies' }] },
    ...
    { id: 2303, type: 'armor', name: 'Juggernaut Armor', rarity: 'Rare', armorType: 'Heavy', art: '../img/armor/juggernaut_armor_card.png', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Juggernaut%20Armor', statBonuses: { DEFENSE: 5, SPD: -2 }, procs: [{ trigger: 'on_status_applied', effect: 'immune_to_status', status: 'Stun' }] },
    { id: 2304, type: 'armor', name: 'Aegis of the Colossus', rarity: 'Epic', armorType: 'Heavy', art: '../img/armor/aegis_of_the_colossus_card.png', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Aegis%20of%20the%20Colossus', statBonuses: { DEFENSE: 6, SPD: -2 }, procs: [{ trigger: 'on_attacked', effect: 'nullify_damage', once_per_combat: true }] },
    ...
    { id: 2402, type: 'armor', name: 'Arcane Shielding', rarity: 'Uncommon', armorType: 'Magic', art: '../img/armor/arcane_shielding_card.png', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Arcane%20Shielding', statBonuses: { DEFENSE: 2, HP: 3 }, procs: [{ trigger: 'on_ability_targeted', effect: 'block_ability', once_per_combat: true }] },
    ...
    { id: 2404, type: 'armor', name: 'Ward of Eternity', rarity: 'Epic', armorType: 'Magic', art: '../img/armor/ward_of_eternity_card.png', imageUrl: 'https://placehold.co/300x400/1e293b/ffffff?text=Ward%20of%20Eternity', statBonuses: { DEFENSE: 4 }, procs: [{ trigger: 'on_attacked', effect: 'immune_to_damage_type', damage_type: 'magic' }] },
];
