...
namespace RogueEngine
{
    ...
    public class MsgMapCard : INetworkSerializable
    {
        public string champion_uid;
    ...
    public class MsgMapItem : INetworkSerializable
    {
        public string champion_uid;
    ...
    public class MsgMapEvent : INetworkSerializable
    {
        public string champion_uid;
        ...
        {
            serializer.SerializeValue(ref champion_uid);
            serializer.SerializeValue(ref event_id);
        }
    }
