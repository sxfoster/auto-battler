		...
		set_loot_items(
			[
				...
				},
				{
					...
					"rarity": 2,
					"tags": [],
					"icon_path": "res://assets/icons/scroll.png"
				}
			]
		)
...
func populate_loot_display():
	...
	for item_data in current_loot_items:
		...
		add_button.pressed.connect(
			_on_add_item_button_pressed.bind(item_data, add_button, item_entry_hbox)
		)
...
func _on_add_item_button_pressed(
	item_data: Dictionary, button_node: Button, _item_entry_node: HBoxContainer
):
