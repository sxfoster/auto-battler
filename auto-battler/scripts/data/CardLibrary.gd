...
static func _create_card(card_name: String, description: String, card_type: CardData.CardType,
        role_restriction: String, class_restriction: String, effect_description: String,
        icon_name: String, synergy_tags: Array = [], energy_cost: int = 1,
        is_combo_starter: bool = false, is_combo_finisher: bool = false) -> CardData:
    var c = CardData.new()
