    ...
    bonuses: [
      {
        ...
        description: 'Burn effects stack +1 time.',
      },
      {
        type: 'Trigger',
        target: 'all',
        effectDetails: { effect: 'IgnoreFirstDotTick' },
        description: 'First damage-over-time tick is ignored.',
      },
      {
        type: 'StatModifier',
        target: 'all',
        effectDetails: { stat: 'fireResist', value: 0.5 },
        description: 'Enemies take 50% less fire damage.',
      },
      {
        type: 'StatModifier',
        target: 'all',
        effectDetails: { stat: 'firePower', value: 1 },
        description: 'Enemies deal +1 fire damage.',
      },
    ],
  },
  {
