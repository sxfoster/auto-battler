...
export const MOCK_HEROES: Record<string, UnitState> = {
  RANGER: {
    ...
    name: 'Ranger',
    class: 'Ranger',
    portraitUrl: '/images/ranger-portrait.png',
    description: 'Expert archer adept at controlling the battlefield from afar.',
    hp: 75,
    maxHp: 75,
    energy: 0,
    speed: 30,
  ...
  BARD: {
    ...
    name: 'Bard',
    class: 'Bard',
    portraitUrl: '/images/bard-portrait.png',
    description: 'A charismatic performer whose music can soothe allies or demoralize foes.',
    hp: 90,
    maxHp: 90,
    energy: 0,
    speed: 25,
